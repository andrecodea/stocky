...
# ── Layout 70 / 30 ────────────────────────────────────────────────────────────
col_stock, col_ia = st.columns([7, 3], gap="large")

# ── Coluna esquerda: tabela de estoque ────────────────────────────────────────
with col_stock:
...
# ── Coluna direita: recomendações IA ──────────────────────────────────────────
with col_ia:
    ...
    if st.button("Analisar estoque", use_container_width=True, type="primary"):
        if not estoque:
            st.warning("Sem dados de estoque para analisar.")
        else:
            with st.spinner("Analisando com IA..."):
                try:
                    from ai_service import recommend_restock
